...
# - QC theresholding applied as in 2.2
...
ppn_predictors <- tribble(
  ...
  "ppn_ad", "PPN axial diffusivity", "cst_ad", "ipsilateral CST axial diffusivity",
  "bilateral_cgm_ad", "whole-brain GM axial diffusivity",
...
cst_predictors <- tribble(
  ...
  "cst_ad", "CST axial diffusivity", "bilateral_cgm_ad", "whole-brain GM axial diffusivity",
